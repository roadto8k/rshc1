...
<br>
<a href="<?php echo Url::to(['semenardk/new-copy', 'id' => $id, 'max' => $max]) ?>" class="btn btn-success">Новая копия</a>
<br><br>
...
<table class="table table-bordered">
    ...
    <?php foreach ($model as $item): ?>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-danger" href="<?= Url::to(['semenardk/copy-delete', 'id' => $item['id']]) ?>">Удалить</a>
            </td>
        </tr>
