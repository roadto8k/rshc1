    ...
    <table border="0" cellpadding="0" cellspacing="0" height="169" width="785">
        ...
        <tr>
            ...
            <td valign="bottom" width="247">
                <div style="width: 260.383px; height: 140px; font-family: Times New Roman; font-size: 16px; line-height: 29px; text-align: center; vertical-align: top; overflow: hidden; text-indent: 10px;"><?= $kartofel['datadeistviya'] ?>
...
<div class="page2">
    <table border="0" cellpadding="0" cellspacing="0" width="785">
        ...
        <tr>
            <td height="109"></td>
            <td style="text-indent: 200px; line-height: 29px; font-family: Times New Roman; font-size: 16px; vertical-align: top;"><?= $kartofel['ispitaniyaprovedeni'] ?></td>
            <td></td>
        </tr>
        </tbody>
    </table>
            ...
            <td colspan="2" style="font-family: Times New Roman; font-size: 16px; height: 640px;" valign="top">
                <table border="1" cellpadding="0" cellspacing="0" style="width: 644px;">
                    ...
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Объединенная проба ( <strong> <?= $kartofel['proba'] ?></strong> ) клубней</td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Сортовая чистота посадок картофеля,%: <strong> <?= $kartofel['chistota'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Наличие клубней других ботанических сортов,%: <strong> <?= $kartofel['botanichsort'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Наличие клубней пораженных болезнями, всего,%: <strong> <?= $kartofel['bolezn'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">В том числе:<strong> </strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Наличие клубней с железистой пятнистостью и потемнением мякоти,%:<strong> <?= $kartofel['jelezist'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Наличие клубней с механическими повреждениями,%: <strong> <?= $kartofel['mehanich'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Наличие клубней с повреждениями с/х вредителями:<strong> <?= $kartofel['vredit'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Наличие клубней, не отвечающих требованиям по размеру, %: <strong> <?= $kartofel['razmer'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Наличие земли и посторонних примесей,%:<strong> <?= $kartofel['primes'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Результаты по определению скрытой зараженности:<strong> <?= $kartofel['scritoi'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Поступило проб для исследования, шт:<strong> <?= $kartofel['probissled'] ?></strong></td>
                    </tr>
                    <tr style="height: 26px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Наличие растений или клубней в образце с положительной реакцией на фитопатогенные вирусы, % по счету:<strong> <?= $kartofel['fitopatog'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">в том числе: ХВК, SBK, MBK:&nbsp;<strong> <?= $kartofel['xbk'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">УВК, ВСЛК: <strong> <?= $kartofel['uvk'] ?></strong></td>
                    </tr>
                    <tr style="height: 23px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Наличие растений или клубней в образце с положительной реакцией на бактериальную инфекцию (черная ножка или кольцевая гниль), % по счету:<strong> <?= $kartofel['bakter'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
                        <td style="height: 13px; border-color: #000000; width: 640px;">Другие определения: <strong> <?= $kartofel['drugie'] ?></strong></td>
                    </tr>
                    <tr style="height: 13px;">
