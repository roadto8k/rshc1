    ...
    <table border="0" cellpadding="0" cellspacing="0" height="169" width="785">
        ...
        <tr>
            ...
            <td valign="bottom" width="247">
                <div style="width: 260.383px; height: 140px; font-family: Times New Roman; font-size: 16px; line-height: 29px; text-align: center; vertical-align: top; overflow: hidden; text-indent: 10px;"><?= $model['datadeistviya'] ?></div>
            </td>
            <td width="57">
                <div style="width: 61px;"></div>
            </td>
...
<div class="page2">
    <table border="0" cellpadding="0" cellspacing="0" width="785">
        ...
        <tr>
            <td height="109"></td>
            <td style="text-indent: 200px; line-height: 29px; font-family: Times New Roman; font-size: 16px; vertical-align: top;"><?= $model['vidannaosnovanii'] ?></td>
            <td></td>
        </tr>
        </tbody>
    </table>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="785">
        ...
        <tr style="height: 56px;">
            ...
            <td align="center" style="width: 222px; vertical-align: top; height: 56px;" valign="bottom" width="222"><?= $model['fio'] ?></td>
            <td style="height: 56px;"><strong>&nbsp;</strong></td>
        </tr>
        </tbody>
    </table>
